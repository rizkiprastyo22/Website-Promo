    ...
    <div class="col s12">
      <div class="card">
        <div class="card-content red lighten-2 white-text">
          ...
          <a href="<?php echo base_url('users/add'); ?>" class="btn-floating right halfway-fab waves-effect waves-light red lighten-4 tooltipped" data-position="top" data-tooltip="Tambah Data"><i class="material-icons">add</i></a>
        </div>
